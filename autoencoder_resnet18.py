# -*- coding: utf-8 -*-
"""Autoencoder_ResNet18.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Iln6Cs-HPgn9Evw34oET5m7wi-EkmRTm
"""
...
autoencoder = ResNet18Autoencoder().to(device)
...
# Convert tensors back to numpy arrays for skimage metrics
inputs_np = inputs.cpu().numpy().transpose(0, 2, 3, 1)
outputs_np = outputs.cpu().numpy().transpose(0, 2, 3, 1)

# Calculate PSNR, SSIM, and MAE for each image in the batch
